            ...
            <div className="edit-profile-container">
                {
                    visible==='name'
                    ?
                    <div  className="edit-profile-container-name-form"><h3>Name</h3>
                    ...
                    <div className="edit-profile-container-name-title">
                        ...
                        <h3>Name</h3>
                        <p>{this.state.name.firstname+" "+this.state.name.middlename+" "+this.state.name.lastname}</p> 
                ...
                }<Divider/>
                {
                    visible==='password'
                    ?
                    <div  className="edit-profile-container-name-form"><h3>Password</h3>
                        <div className="form-container">
                        ...
                        <div className="form-container">
                            <Form layout="inline" onSubmit={this.handleSubmitPassword}>
                                ...
                                {getFieldDecorator("phone", {
                                    ...
                                    <Input addonBefore={prefixSelector} max="10" style={{ width: "100%" }} />
                                )}
                                </FormItem><br/>
